...
from imf_data_processor import IMFDataProcessor
...
class SelectIndicatorsFrame(tk.Frame):
    def __init__(self,master):
        ...
        tk.Button(self,text='Go Back Data Source Select',command=lambda:master.switch_frame(ChooseDataSourceFrame)).pack(side=tk.TOP)
